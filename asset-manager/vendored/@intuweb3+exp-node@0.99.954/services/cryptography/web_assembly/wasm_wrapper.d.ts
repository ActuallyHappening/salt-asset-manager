import { SeedResponse, PreRegisterResponse, DecryptResponse, EncryptResponse, RegisterStepTwoResponse, RegisterStepThreeResponse, SignTransactionResponse, CombineTransactionsResponse, PolybaseKeyResponse } from "../types/models";
export declare function _createSeed(): Promise<SeedResponse>;
export declare function _createRandomMessage(): Promise<any>;
...
export declare function _formTransaction(to: string, value: string, chainId: string, nonce: string, data: string, gasPrice: string, gas: string, decimal: string): Promise<string>;
