...
import type { VaultManager, VaultManagerInterface } from "../../../contracts/VaultManager.sol/VaultManager";
export declare class VaultManager__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): VaultManager;
}
