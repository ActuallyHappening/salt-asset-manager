...
export declare function createVault(proposedAddresses: any[], vaultName: string, rotateThreshold: number, transactionThreshold: number, adminThreshold: number, message: string, groupRng: string, signer: Signer, returnHash: boolean): Promise<string | ethers.ContractTransaction | undefined>;
