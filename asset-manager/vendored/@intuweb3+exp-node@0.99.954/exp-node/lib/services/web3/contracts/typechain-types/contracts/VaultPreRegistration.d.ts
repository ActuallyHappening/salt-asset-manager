...
export interface VaultPreRegistrationInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "VAULT_USER_COUNT_LIMIT" | "preRegister" | "transactionVotes" | "transactions" | "userInfos" | "usersMapping" | "vault" | "vaultInfos"): FunctionFragment;
...
export interface VaultPreRegistration extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: VaultPreRegistrationInterface;
