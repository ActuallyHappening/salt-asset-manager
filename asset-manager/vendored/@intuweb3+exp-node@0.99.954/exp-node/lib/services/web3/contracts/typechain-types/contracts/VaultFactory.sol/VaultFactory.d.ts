...
export interface VaultFactoryInterface extends utils.Interface {
    functions: {
        "createVault(address[],string,uint8,uint8,uint8,string,string)": FunctionFragment;
    ...
    events: {
        "VaultCreated(address,address[],string,string,string)": EventFragment;
    };
...
export interface VaultFactory extends BaseContract {
    ...
    functions: {
        createVault(proposedAddresses: PromiseOrValue<string>[], vaultName: PromiseOrValue<string>, rotateThreshold: PromiseOrValue<BigNumberish>, transactionThreshold: PromiseOrValue<BigNumberish>, adminThreshold: PromiseOrValue<BigNumberish>, encryptionMessage: PromiseOrValue<string>, seed: PromiseOrValue<string>, overrides?: PayableOverrides & {
    ...
    callStatic: {
        createVault(proposedAddresses: PromiseOrValue<string>[], vaultName: PromiseOrValue<string>, rotateThreshold: PromiseOrValue<BigNumberish>, transactionThreshold: PromiseOrValue<BigNumberish>, adminThreshold: PromiseOrValue<BigNumberish>, encryptionMessage: PromiseOrValue<string>, seed: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        feeContractAddress(overrides?: CallOverrides): Promise<string>;
        impl(overrides?: CallOverrides): Promise<string>;
        managerAddress(overrides?: CallOverrides): Promise<string>;
        paused(overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {
        "VaultCreated(address,address[],string,string,string)"(vaultAddress?: PromiseOrValue<string> | null, _proposedAddresses?: null, name?: null, _encryptionMessage?: null, _seed?: null): VaultCreatedEventFilter;
