...
export declare namespace VaultManager {
    type VaultStruct = {
        ...
        encryptionMessage: PromiseOrValue<string>;
...
export interface VaultManagerInterface extends utils.Interface {
    ...
    events: {
        "TransactionProposed(uint256,string)": EventFragment;
        "TransactionUserConfirmed(uint256,address,string)": EventFragment;
        "VaultCompleted(address[],string)": EventFragment;
...
export interface VaultManager extends BaseContract {
    ...
    filters: {
        "TransactionProposed(uint256,string)"(txId?: PromiseOrValue<BigNumberish> | null, transactionInfo?: null): TransactionProposedEventFilter;
        TransactionProposed(txId?: PromiseOrValue<BigNumberish> | null, transactionInfo?: null): TransactionProposedEventFilter;
        ...
        "VaultCompleted(address[],string)"(users?: null, _masterPubKey?: null): VaultCompletedEventFilter;
