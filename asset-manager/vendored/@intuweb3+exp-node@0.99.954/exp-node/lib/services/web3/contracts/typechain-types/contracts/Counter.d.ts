...
export interface CounterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "increment" | "number" | "setNumber"): FunctionFragment;
    encodeFunctionData(functionFragment: "increment", values?: undefined): string;
    encodeFunctionData(functionFragment: "number", values?: undefined): string;
    encodeFunctionData(functionFragment: "setNumber", values: [PromiseOrValue<BigNumberish>]): string;
...
export interface Counter extends BaseContract {
    ...
    functions: {
        ...
        setNumber(newNumber: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    increment(overrides?: Overrides & {
    ...
    callStatic: {
        ...
        number(overrides?: CallOverrides): Promise<BigNumber>;
        setNumber(newNumber: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        increment(overrides?: Overrides & {
