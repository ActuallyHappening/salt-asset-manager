...
export interface MessageInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "VAULT_USER_COUNT_LIMIT" | "messageCount" | "messages" | "messagesSigned" | "transactionVotes" | "transactions" | "userInfos" | "usersMapping" | "vault" | "vaultInfos"): FunctionFragment;
