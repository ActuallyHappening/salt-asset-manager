...
export async function registerStepThree(seed, threshold, index, megaPkArray, encryptionSignature, encryptedMegaSecret, dealingsKeyArray, // step1
dealingsKappaArray, // step1
transcriptKeySingle, // step 2
transcriptKappaSingle, // step 2
...
export async function reshareSignTransaction(seed, threshold_reshare, index, message, encryptionSignature, encryptedMegaSecret, pedersenDealingsLambdaReshare, dealingsKeyXlambdaReshare, // from previous
dealingsKappaXlambdaReshare, // from previous
pedersenOpeningLambdaReshare, transcriptKeyResharedTwice, simpleTranscriptKappaReshare) {
