...
pedersenOpeningLambdaReshare, transcriptKeyResharedTwice, simpleTranscriptsKappaReshare) {
    ...
    signedTransaction = user_sign_message_reshare(openings_kappa_times_lambda_reshare_decrypted, openings_key_times_lambda_reshare_decrypted, lambdaOpening, //from step 2
    transcriptKeyResharedTwice, //from step1
    simpleTranscriptsKappaReshare, message, seed);
    return { signedTransaction: signedTransaction };
}
